...
class UANet_final(nn.Module):
    def __init__(self, channel, num_classes):
        super(UANet_final, self).__init__()
        ...
        self.conv_2 = nn.Sequential(SEM(128,channel))
        self.conv_3 = nn.Sequential(SEM(256,channel))
        self.conv_4 = nn.Sequential(SEM(512,channel))
        self.conv_5 = nn.Sequential(SEM(512,channel))
        ...
        self.ufm_layer4 = Uncertainty_Fusion_Module(high_channel = channel,low_channel = channel, out_channel = channel, num_classes=num_classes)
        self.ufm_layer3 = Uncertainty_Fusion_Module(high_channel = channel,low_channel = channel, out_channel = channel, num_classes=num_classes)
        self.ufm_layer2 = Uncertainty_Fusion_Module(high_channel = channel,low_channel = channel, out_channel = channel,num_classes=num_classes)
        self.ufm_layer1 = Uncertainty_Fusion_Module(high_channel = channel,low_channel = channel, out_channel = channel, num_classes=num_classes)
...
class UANet_final_Res50(nn.Module):
    def __init__(self, channel, num_classes):
        super(UANet_final_Res50, self).__init__()
        self.backbone = resnet50(backbone_path='./pretrain_models/resnet/resnet50-19c8e357.pth') 

        self.conv_1 = BasicConv2d(64,channel,3,1,1)
        self.conv_2 = nn.Sequential(SEM(256,channel))
        self.conv_3 = nn.Sequential(SEM(512,channel))
        self.conv_4 = nn.Sequential(SEM(1024,channel))
        self.conv_5 = nn.Sequential(SEM(2048,channel))
...
class UANet_final_Res250(nn.Module):
    def __init__(self, channel, num_classes):
        super(UANet_final_Res250, self).__init__()
...
class UANet_final_pvt(nn.Module):
    def __init__(self, channel, num_classes):
        super(UANet_final_pvt, self).__init__()
        self.backbone = pvt_v2_b2()  # [64, 128, 320, 512]
        path = '/home/henry/Code/ICCV_B/pretrain_model/pvt_v2_b2.pth'
        ...
        self.conv_2 = nn.Sequential(SEM(64,channel))
        self.conv_3 = nn.Sequential(SEM(128,channel))
        self.conv_4 = nn.Sequential(SEM(320,channel))
        self.conv_5 = nn.Sequential(SEM(512,channel))
